...
class RobotDemos:
    ...
    async def _run_digit_2_demo(self):
    ...
    async def _run_digit_3_demo(self):
    ...
    async def _run_digit_4_demo(self):
    ...
    async def _run_digit_5_demo(self):
    ...
    async def _run_digit_6_demo(self):
    ...
    async def _run_digit_7_demo(self):
    ...
    async def _run_digit_8_demo(self):
    ...
    async def _run_digit_9_demo(self):
    ...
    # --- 方步 ---
    async def _run_box_step_demo(self):
    ...
    # --- S 形曲线 ---
    async def _run_s_curve_demo(self):
    ...
    # --- Z 形曲线 ---
    async def _run_z_curve_demo(self):
    ...
    # --- 原地高速旋转 ---
    async def _run_spin_fast_demo(self):
